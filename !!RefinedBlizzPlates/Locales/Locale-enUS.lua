...
L["Non-target Alpha Mod"] = true
L["Overrides non-target nameplate opacity. May slightly increase CPU usage."] = true
...
L["Low Health Coloring"] = true
L["Enemy Players"] = true
L["Enemy NPCs"] = true
L["Friendly Players"] = true
L["Friendly NPCs"] = true
L["Threshold"] = true
L["Overrides health bar colors when health is at or below the configured percentage threshold."] = true
...
L["The name text is used as the indicators' anchor reference, even when disabled."] = true
...
L["Player Health Text"] = true
L["Sets the anchor point relative to the name text."] = true
L["NPC Health Text"] = true
